...
def load_data(data_path: str, limit: int, cache_dir: str = None):
    cache_file = None
    if cache_dir:
        os.makedirs(cache_dir, exist_ok=True)
        cache_file = os.path.join(cache_dir, f"voice_data_limit_{limit}.pkl")
    ...
    if cache_file and os.path.exists(cache_file):
        ...
        positive_triples, negative_triples = to_triples(data_path, limit)
...
def train_model(
    ...
    for epoch in range(num_epochs):
        ...
        if checkpoint_path:
            name = os.path.join(
                checkpoint_path,
                f"{timestamp}_e{epoch+1}_tr{train_loss:.4f}_te{test_loss:.4f}_ac{accuracy:.4f}.pth",
            )
...
# DATA_PATH = "/Users/Dolg/Documents/Flatiron/capstone/data_numbers_wav"
# CACHE_DIR = "/Users/Dolg/Documents/cache"
# TRAIN_CHECKPOINT_PATH = "/Users/Dolg/Documents/Flatiron/capstone/checkpoints"

DATA_PATH = "/root/learning-nn/resources/speech_commands"
CACHE_DIR = "/root/learning-nn/resources/cache"
TRAIN_CHECKPOINT_PATH = "/root/learning-nn/resources/checkpoints"
...
#         train, test = load_data(DATA_PATH, dataset_limit, cache_dir=CACHE_DIR)
#         for lr in [0.0003, 0.001, 0.0002, 0.0001]:
